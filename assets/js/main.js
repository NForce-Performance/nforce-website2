...
(function () {
  ...
  /* ---------- Desktop dropdown "Diensten" ----------
     Zelfde interactiepatroon als de taalkiezer hierboven: klik/Enter
     opent en sluit, Escape sluit en zet focus terug op de knop, een
     klik buiten het menu sluit het. Extra: hover opent/sluit ook,
     zodat het op een pointer-apparaat als een gewoon navmenu voelt.
     Alleen relevant vanaf 1120px; daaronder toont de mobiele nav. */
  document.querySelectorAll('[data-nav-drop]').forEach(function (host) {
    var toggle = host.querySelector('.nav-drop__toggle');
    var menu = host.querySelector('.nav-drop__menu');
    ...
    host.addEventListener('mouseleave', function () {
      hoverTimer = window.setTimeout(function () { setOpen(false); }, 120);
    });
